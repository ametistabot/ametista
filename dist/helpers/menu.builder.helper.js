...
export const mainMenu = (botInfo) => {
    ...
    return `*|*━━━ ✦ *💜💫 ${name?.trim()}* ✦ ━━━
*|*
*|* 📲 _Digite *${prefix}reportar* mensagem para suporte!_
*|*
*|*━━━ ✦ 🔎 *MENU PRINCIPAL* ✦
...
*|*
*|*━━ ✦ 🧩 *ENTRETENIMENTO* ✦
*|*► *${prefix}simsimi* - Converse com o Simsimi
...
*|*► *${prefix}tarot* - Tira três cartas do tarot e revela suas interpretações
*|*
*|*━━━━━━━━━━━✦━━━━━━━━━━━`;
};
// MENU - VARIADO (GRUPO)
...
*|*━━ ✦ 🧩 *ENTRETENIMENTO* ✦
*|*► *${prefix}simsimi* - Converse com o Simsimi
*|*► *${prefix}emojifilme* - Adivinhe o filme pelos emojis com seus amigos
*|*► *${prefix}forca* - Inicie o jogo da forca
*|*► *${prefix}mascote* - Onipotente e onipresente WhatsApp Jr
*|*► *${prefix}frase* - Frase dúvidosa do WhatsApp Jr
*|*► *${prefix}tarot* - Tira três cartas do tarot e revela suas interpretações
