...
const infoCommands = {
    ...
    reportar: {
        guide: `Ex: *{$p}reportar* mensagem - Entra em contato com a administração do Bot.\n`,
        msgs: {
            reply: `⚒️ Obrigado, a administração do bot recebeu sua mensagem!`,
            error: '[❗] Não foi possível enviar a mensagem para o dono, pois ele ainda não está cadastrado.',
            reply_admin: "📢 *Reportar*\n\n" +
                "*Usuário*: {$1}\n" +
