...
const groupCommands = {
    ...
    fotogrupo: {
        guide: `Ex: Envie/responda uma *imagem* com *{$p}fotogrupo* - Altero a foto do grupo.\n\n`,
        msgs: {
    ...
    aviso: {
        ...
        msgs: {
            reply: '*🥴 Vixe!*\n\n' +
                "@{$1}, você recebeu um aviso do administrador, se chegar a 3 avisos você será adicionado a lista negra do grupo, cuidado!\n\n" +
                '*Atualmente você tem {$2} avisos.*',
            reply_max_warning: '🥴 Vixe!\n\n' +
    ...
    addlista: {
        ...
        msgs: {
            reply: "⚒️ O número desse usuário foi adicionado á lista negra e será banido do grupo caso ainda esteja aqui.",
    ...
    rmlista: {
        ...
        msgs: {
            reply: "⚒️ O número desse usuário foi removido da lista negra.",
    ...
    add: {
        ...
        msgs: {
            reply: '⚒️ O número +{$1} foi adicionado ao grupo com sucesso.',
    ...
    adms: {
        ...
        msgs: {
            reply: "📢 Alô admins!",
            reply_with_message: "📢 Mensagem para os *admins*:\n\n" +
                "*{$2}*\n",
        },
    ...
    mutar: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *MUTAR GRUPO* foi ativado com sucesso",
            reply_off: "⚒️ O recurso de *MUTAR GRUPO* foi desativado com sucesso"
        },
    ...
    rlink: {
        ...
        msgs: {
            ...
            reply: "⚒️ Link do grupo foi redefinido com sucesso."
        },
    ...
    restrito: {
        ...
        msgs: {
            reply_on: "⚒️ O grupo foi restrito apenas para *ADMINISTRADORES* poderem conversar.",
            reply_off: '⚒️ O grupo foi liberado para todos os *MEMBROS* poderem conversar.'
        },
    ...
    autoresp: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *RESPOSTA AUTOMÁTICA* foi ativado com sucesso.",
            reply_off: "⚒️ O recurso de *RESPOSTA AUTOMÁTICA* foi desativado com sucesso."
        },
    ...
    addresp: {
        ...
        msgs: {
            reply_added: '⚒️ A resposta automática para a palavra *{$1}* foi adicionada com sucesso.\n\n' +
    ...
    rmresp: {
        ...
        msgs: {
            reply_removed: '⚒️ A resposta automática para a palavra *{$1}* foi removida com sucesso.',
            error_not_exist: '[❗] Não existe uma resposta automática configurada para a palavra *{$1}*',
            reply_title: '⚒️ *Resposta automática*\n\n',
    ...
    antilink: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *ANTI-LINK* foi ativado com sucesso.",
            reply_off: "⚒️ O recurso de *ANTI-LINK* foi desativado com sucesso."
        },
    ...
    autosticker: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *AUTO-STICKER* foi ativado com sucesso.",
            reply_off: "⚒️ O recurso de *AUTO-STICKER* foi desativado com sucesso."
        },
    ...
    bemvindo: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *BOAS VINDAS* foi ativado com sucesso.",
            reply_off: "⚒️ O recurso de *BOAS VINDAS* foi desativado com sucesso.",
        },
    ...
    antifake: {
        ...
        msgs: {
            reply_on: "⚒️ O recurso de *ANTI-FAKE* foi ativado com sucesso.",
            reply_off: "⚒️ O recurso de *ANTI-FAKE* foi desativado com sucesso."
        },
    ...
    antiflood: {
        ...
        msgs: {
            ...
            reply_on: "⚒️ O recurso de *ANTI-FLOOD* foi ativado para *{$1}* mensagens a cada *{$2}* segundos.",
            reply_off: "⚒️ O recurso de *ANTI-FLOOD* foi desativado com sucesso."
        },
